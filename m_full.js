      ...
      for ( var G in A )
         {
            new Native (
               {
                  name: G, initialize: A[G], protect: 1
               })
         }
      ...
      for ( var E in F )
         {
            for ( var B = F[E].length; B --; )
               {
                  Native.genericize ( window[E], F[E][B], 1 )
               }
         }
   })();
...
function $type ( A )
   {
      ...
      if ( A.$family )
         {
            return ( A.$family.name == "number" && !isFinite ( A ) ) ?0: A.$family.name
         }
            ...
            switch ( A.nodeType )
               {
                  ...
                  case 3: return ( new RegExp ( "\\S" ) ) .test ( A.nodeValue ) ?"textnode": "whitespace"
               }
         }
...
var Browser = $merge (
   {
      ...
      , Platform:
         {
            name: ( window.orientation != undefined ) ?"ipod": ( navigator.platform.match ( new RegExp ( "mac|win|linux", "i" ) ) || ["other"] ) [0].toLowerCase ()
         }
      ...
      , Engines:
         {
            presto: function ()
               {
                  return ( !window.opera ) ?0: ( ( arguments.callee.caller ) ?960: ( ( document.getElementsByClassName ) ?950: 925 ) )
               }

            , trident: function ()
               {
                  return ( !window.ActiveXObject ) ?0: ( ( window.XMLHttpRequest ) ?5: 4 )
               }

            , webkit: function ()
               {
                  return ( navigator.taintEnabled ) ?0: ( ( Browser.Features.xpath ) ? ( ( Browser.Features.query ) ?525: 420 ) : 419 )
               }

            , gecko: function ()
               {
                  return ( document.getBoxObjectFor == undefined ) ?0: ( ( document.getElementsByClassName ) ?19: 18 )
               }
         }
   }
...
Browser.Platform[Browser.Platform.name] = 1;
            ...
            if ( A )
               {
                  ...
                  this.Engine[B] = this.Engine[B + A] = 1;
                  break
               }
         }
      return {
            ...
            if ( Browser.Engine.trident && Browser.Engine.version <= 4 )
               {
                  $try ( function ()
                     {
                        A.execCommand ( "BackgroundImageCache", 0, 1 )
                     })
               }
...
String.implement (
   {
      ...
      , clean: function ()
         {
            return this.replace ( new RegExp ( "\\s+", "g" ), " " ) .trim ()
         }

      , camelCase: function ()
         {
            return this.replace ( new RegExp ( "-\\D", "g" ), function ( A )
               {
      ...
      , hyphenate: function ()
         {
            return this.replace ( new RegExp ( "[A-Z]", "g" ), function ( A )
               {
      ...
      , capitalize: function ()
         {
            return this.replace ( new RegExp ( "\\b[a-z]", "g" ), function ( A )
               {
      ...
      , hexToRgb: function ( B )
         {
            var A = this.match ( new RegExp ( "^#?(\\w{1,2})(\\w{1,2})(\\w{1,2})$" ) );
            return ( A ) ?A.slice ( 1 ) .hexToRgb ( B ) : null
         }

      , rgbToHex: function ( B )
         {
            var A = this.match ( new RegExp ( "\\d{1,3}", "g" ) );
      ...
      , stripScripts: function ( B )
         {
            ...
            var C = this.replace ( new RegExp ( "<script[^>]*>([\\s\\S]*?)<\\/script>", "gi" ), function ()
               {
                  A += arguments[1] + "\n";
                  return""
               });
      ...
      , substitute: function ( A, B )
         {
            return this.replace ( B || ( new RegExp ( "\\?\{([^{}]+)\}", "g" ) ), function ( D, C )
               {
                  if ( D.charAt ( 0 ) == "\\" )
                     {
                        return D.slice ( 1 )
      ...
      name: "Event", initialize: function ( A, F )
         {
            ...
            if ( J.test ( new RegExp ( "key" ) ) )
               ...
               {
                  if ( J.match ( new RegExp ( "(click|mouse|menu)", "i" ) ) )
                     {
                        ...
                        if ( J.match ( new RegExp ( "DOMMouseScroll|mousewheel" ) ) )
                           {
                        ...
                        if ( J.match ( new RegExp ( "over|out" ) ) )
                           {
                              switch ( J )
                                 {
...
Events.removeOn = function ( A )
   {
      return A.replace ( new RegExp ( "^on([A-Z])" ), function ( B, C )
         {
      ...
      setOptions: function ()
         {
            ...
            for ( var A in this.options )
               {
                  if ( $type ( this.options[A] ) != "function" || ! ( new RegExp ( "^on[A-Z]" ) ) .test ( A ) )
                     {
                        continue
                     }
...
var IFrame = new Native (
   {
      name: "IFrame", generics: 0, initialize: function ()
         {
                  ...
                  switch ( $type ( E ) )
                     {
                        ...
                        break;
                        case "string": F.extend ( this.document.getElements ( E, 1 ) )
                     }
               }
...
$.element = function ( A, D )
   {
      ...
      if ( !D && !A.$family && ! ( new RegExp ( "^object|embed$", "i" ) ) .test ( A.tagName ) )
         {
...
Native.implement ( [Element, Document],
   {
      getElement: function ( A, B )
         {
            return $ ( this.getElements ( A, 1 ) [0] || null, B )
         }
            ...
            if ( Browser.Engine.trident )
               {
                  ...
                  if ( ( new RegExp ( "object", "i" ) ) .test ( N.tagName ) )
                     {
                        for ( var O in N )
                           {
      ...
      Element.implement (
         {
            ...
            , removeProperty: function ( M )
               {
                  var L = E[M];
                  ( L ) ?this[L] = ( L && B[M] ) ?0: "": this.removeAttribute ( M );
                  return this
               }
            ...
            , getPrevious: function ( L, M )
               {
                  return J ( this, "previousSibling", null, L, 0, M )
               }

            , getAllPrevious: function ( L, M )
               {
                  return J ( this, "previousSibling", null, L, 1, M )
               }

            , getNext: function ( L, M )
               {
                  return J ( this, "nextSibling", null, L, 0, M )
               }

            , getAllNext: function ( L, M )
               {
                  return J ( this, "nextSibling", null, L, 1, M )
               }

            , getFirst: function ( L, M )
               {
                  return J ( this, "nextSibling", "firstChild", L, 0, M )
               }

            , getLast: function ( L, M )
               {
                  return J ( this, "previousSibling", "lastChild", L, 0, M )
               }

            , getParent: function ( L, M )
               {
                  return J ( this, "parentNode", null, L, 0, M )
               }

            , getParents: function ( L, M )
               {
                  return J ( this, "parentNode", null, L, 1, M )
               }

            , getChildren: function ( L, M )
               {
                  return J ( this, "nextSibling", "firstChild", L, 1, M )
               }
            ...
            , toQueryString: function ()
               {
                  ...
                  this.getElements ( "input, select, textarea", 1 ) .each ( function ( M )
                     {
            ...
            , removeListener: function ( M, L )
               {
                  if ( this.removeEventListener )
                     {
                        this.removeEventListener ( M, L, 0 )
                     }
      ...
      , getStyle: function ( G )
         {
            ...
            if ( A )
               {
                  A = String ( A );
                  var C = A.match ( new RegExp ( "rgba?\\([\\d\\s,]+\\)" ) );
            ...
            if ( Browser.Engine.presto || ( Browser.Engine.trident && !$chk ( parseInt ( A ) ) ) )
               {
                  if ( G.test ( new RegExp ( "^(height|width)$" ) ) )
                     {
                  ...
                  if ( G.test ( new RegExp ( "(border(.+)Width|margin|padding)" ) ) )
                     {
                        return"0px"
                     }
               }
...
( function ()
   {
      ...
      function B ( H )
         {
            return ( new RegExp ( "^(?:body|html)$", "i" ) ) .test ( H.tagName )
         }
...
var Cookie = new Class (
   {
      Implements: Options, options:
         {
            path: 0, domain: 0, duration: 0, secure: 0, document: document
         }
...
var Swiff = new Class (
   {
      Implements: [Options], options:
         {
            id: null, height: 1, width: 1, container: null, properties:{}

            , params:
               {
                  quality: "high", allowScriptAccess: "always", wMode: "transparent", swLiveConnect: 1
               }
      ...
      , inject: function ( A )
         {
            $ ( A, 1 ) .appendChild ( this.toElement () );
            return this
         }
...
var Request = new Class (
   {
      Implements: [Chain, Events, Options], options:
         {
            ...
            , async: 1, format: 0, method: "post", link: "ignore", isSuccess: null, emulation: 1, urlEncoded: 1, encoding: "utf-8", evalScripts: 0, evalResponse: 0
         }
      ...
      , processScripts: function ( A )
         {
            if ( this.options.evalResponse || ( new RegExp ( "(ecma|java)script" ) ) .test ( this.getHeader ( "Content-type" ) ) )
               {
                  return $exec ( A )
               }
      ...
      , send: function ( I )
         {
            ...
            switch ( $type ( E ) )
               {
                  case "element": E = $ ( E ) .toQueryString ();
                  break;
